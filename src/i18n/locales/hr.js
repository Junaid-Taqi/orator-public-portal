const hr = {
  ...
  calendar: {
    ...
    tags: 'Oznake',
    clearAll: 'Očisti sve',
    dateSelectionType: 'Vrsta odabira datuma',
    selected: 'odabrano',
    tag: {
      health: '🏥 Zdravlje',
      sport: '⚽ Sport',
    ...
    singleDate: 'Jedan datum događaja',
    singleDateDesc: 'Događaji koji se održavaju na jedan točan datum',
    dateRange: 'Raspon datuma',
    dateRangeDesc: 'Događaji koji traju više uzastopnih dana',
    multipleDates: 'Višestruki datumi',
    multipleDatesDesc: 'Događaji koji se ponavljaju na više odvojenih datuma',
    jan: 'Siječanj',
    feb: 'Veljača',
    mar: 'Ožujak',
    apr: 'Travanj',
