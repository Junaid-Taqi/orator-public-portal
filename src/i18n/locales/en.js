const en = {
  ...
  calendar: {
    ...
    tags: 'Tags',
    clearAll: 'Clear All',
    dateSelectionType: 'Date Selection Type',
    selected: 'selected',
    tag: {
      health: '🏥 Health',
      sport: '⚽ Sport',
    ...
    singleDate: 'Single Date Event',
    singleDateDesc: 'Events occurring on one specific date',
    dateRange: 'From-To Date Range',
    dateRangeDesc: 'Events spanning multiple consecutive days',
    multipleDates: 'Multiple Dates Event',
    multipleDatesDesc: 'Events recurring on multiple separate dates',
    jan: 'January',
    feb: 'February',
    mar: 'March',
    apr: 'April',
