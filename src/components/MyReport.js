    ...
    <div className="report-dashboard py-5">
      <div className="container">
        ...
        <header className="mb-4">
          <h2 className="text-white">My Reports</h2>
          <p className="text-info opacity-75">Track the status of your submitted reports</p>
        </header>
        ...
        <div className="glass-card p-2 mb-4 d-flex align-items-center">
          <div className="px-3 border-end border-white-10">
            <span className="text-info">Filter</span>
          </div>
        ...
        <div className="glass-card p-4 shadow-lg border-0">
          <div className="d-flex justify-content-between align-items-start mb-3">
            <div>
              ...
              <span className="badge rounded-pill bg-success-soft text-success border border-success">✓ Finished</span>
            </div>
            <div className="text-end">
              <small className="d-block text-info opacity-50">RPT-45782</small>
              <a href="#" className="text-info text-decoration-none small"><FontAwesomeIcon icon="faEye" className="me-1" /> View Details</a>
            </div>
          </div>
          ...
          <p className="text-white-50 fst-italic mb-5 border-top border-white-10 pt-3">This issue has been resolved.</p>

          {/* Status History Timeline */}
          <h6 className="text-white mb-4 text-uppercase small tracking-widest">Status History</h6>
          <div className="timeline-container ps-3">
            <div className="timeline-item mb-4 pb-2">
              <div className="d-flex align-items-center gap-2">
                <span className="text-white">Report submitted</span>
            ...
            <div className="timeline-item mb-4 pb-2">
              <div className="d-flex align-items-center gap-2">
                <span className="text-white">Report authorized by municipality</span>
